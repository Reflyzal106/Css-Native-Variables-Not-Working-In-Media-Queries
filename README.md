# [SOLVED] Css-Native-Variables-Not-Working-In-Media-Queries
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/css-native-variables-not-working-in-media-queries)
>
...
Check if you're using `var(--variable-name)` correctly, as it should be `var(--mobile-breakpoint)` instead of `var(var(--mobile-breakpoint)).
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/css-native-variables-not-working-in-media-queries)**
